        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    <div> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                        <h1 className='cart'>
                            <span className='cart_quantity_count'>{cartItems ? cartItems.reduce((sum, item) => sum + item.quantity, 0) : 0}</span>
            ...
            {!showCart ? (
                ...
                <div key={index}> {/* Unique key for each category div */}
                    <h1>
                    <div style={{textAlign: 'center', padding: '15px 0'}}>{category.category}</div> {/* Display the category name */}
                    </h1>
